...
CONFIG = ROOT / "content/g5/batches/06_foreign_semantic_gap_config.json"
TODAY = "2026-09-18"
...
def main():
    ...
    for card in cfg["cards"]:
        ...
        target_is_ja = card["language_code"].startswith("ja")
        target_is_en = card["language_code"].startswith("en")
        cost = {
        ...
        rr = {
            ...
            "comparisons": {
                ...
                "en": comparison(
                    "PASS" if target_is_en else "HOLD",
                    card["en_near_terms"],
                ...
                "ja": comparison(
                    "PASS" if target_is_ja else "HOLD",
                    card["ja_near_terms"],
    ...
    batch = {
        ...
        "config": "content/g5/batches/06_foreign_semantic_gap_config.json",
    }
    write_json("content/g5/batches/06_foreign_semantic_gap_research.json", batch)
