...
CONFIG = ROOT / "content/g5/batches/03_foreign_semantic_gap_config.json"
TODAY = "2026-09-17"
...
def main():
    ...
    batch = {
        ...
        "config": "content/g5/batches/03_foreign_semantic_gap_config.json",
    }
    write_json("content/g5/batches/03_foreign_semantic_gap_research.json", batch)
